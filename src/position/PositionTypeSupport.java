...
public class PositionTypeSupport extends TypeSupportImpl {
    ...
    // Private Fields
    // -----------------------------------------------------------------------
    private static final String TYPE_NAME = "model.Position";
...
//        currentAlignment  +=  CdrPrimitiveType.getStringSerializedSize(epd.getAlignment(currentAlignment), typedSrc.Position );
        if (include_encapsulation) {
            currentAlignment += encapsulation_size;
        }
        return currentAlignment - origAlignment;
    ...
    public void serialize(Object endpoint_data,Object src, CdrOutputStream dst,boolean serialize_encapsulation,
        ...
        if(serialize_sample) {
            ...
            dst.writeString(typedSrc.trafficConditions,256);
            dst.writeString(typedSrc.route,256);
            dst.writeString(typedSrc.vehicle, 256);
            dst.writeString(typedSrc.trafficConditions, 256);
            dst.writeLong(typedSrc.stopNumber);
            dst.writeLong(typedSrc.numStops);
            dst.writeLong(typedSrc.timeBetweenStops);
            dst.writeLong(typedSrc.fillInRatio);
            dst.writeString(typedSrc.timestamp);
            ...
            Object endpoint_plugin_qos)
    {
        ...
        if(deserialize_sample) {
            ...
            try{
//                Position typedSrc = (Position) src;
                typedDst.trafficConditions = src.readString(256);
                typedDst.route = src.readString(256);
                typedDst.vehicle = src.readString(256);
                typedDst.trafficConditions = src.readString(256);
                typedDst.stopNumber = src.readLong();
                typedDst.numStops = src.readLong();
                typedDst.timeBetweenStops = src.readLong();
                typedDst.fillInRatio = src.readLong();
                typedDst.timestamp = src.readString(256);
