/* MessagePublisher.java
   ...
   (3) Start the publication on the same domain used for RTI Connext with the command
       java MessagePublisher <domain_id> <sample_count>
   ...
   Example:
       ...
       Run the Java applications:
        ...
        java -Djava.ext.dirs=$(NDDSHOME)/class MessagePublisher <domain_id>
...
public class MessagePublisher {
    ...
    private static void publisherMain(int domainId, int sampleCount) {
        ...
        try {
            ...
            final long sendPeriodMillis = (long) (.25 * 1000); // .25 seconds
            for (int count = 0;
                 (sampleCount == 0) || (count < sampleCount);
                 ++count) {
                instance.msg = MessageRandomizer.createMessage();
                instance.sender = MessageRandomizer.createSender();
                instance.number = count;
                System.out.println("Writing Msg: " + instance);
